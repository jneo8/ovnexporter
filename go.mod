module github.com/canonical/ovnexporter

go 1.24.5

require (
	github.com/ovn-org/libovsdb v0.6.1-0.20240125124854-03f787b1a892
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20250731031808-6082160282cf
...
require (
	...
	github.com/k8snetworkplumbingwg/ipamclaims v0.5.0-alpha // indirect
...
replace (
	...
	github.com/ovn-org/ovn-kubernetes/go-controller => /home/jneo8/Github/ovn-kubernetes/go-controller
)
